...
checkbox.change(function (event) {
  ...
  if (checkbox.checked) {
    ...
    //document.getElementById('inputregex').setAttribute('disabled','disabled');
    ...
    //document.getElementById('inputregex').setAttribute('enabled','true');
    //alert(localStorage.getItem("a"));
    $("#off").css("color", "black");
    $("#on").css("color", "red");
     $("#sah").hide();
...
var SHOW_HISTORY_TITLE = "afficher historique";
var HIDE_HISTORY_TITLE = "cacher historique";
...
var HISTORY_IS_EMPTY_TEXT = "historique est vide !";
var CLEAR_ALL_HISTORY_TEXT = "vider historique";
...
=======
>>>>>>> 72e71bace250911446839bbc585f140f49bd9748
      });
    }
    console.log(result);
